...
#' Idea from Alex Gable (\url{https://twitter.com/gableingaround}).
#'
#' @param from The start date. Typically the player's birth date.
#' @param to The reference date. Used for finding a player's draft eligibility,
#' it's typically \code{2018-09-15}, or whatever the year of the NHL draft is.
#' @examples
